...
class FA7X(VelocitySpeed):
    '''
    Velocity speed tables for Falcon 7X
    '''
    interpolate = True
    source = 'Falcon 7X'
    weight_unit = ut.LB
    tables = {
        'v2': {
            'weight': (40000, 45000, 50000, 55000, 60000, 65000, 69000),
                 '9': (109, 115, 121, 126, 131, 136, 140),
                 '20': (107, 111, 115, 120, 124, 129, 132),
##                   '40': (113, 119, 126, 132, 139, 145, 152),
           },
        'vref': {
            'weight': (40000, 45000, 50000, 55000, 60000, 65000, 69000),
                '9': (106, 113, 119, 125, 130, 135, 139),
                '20': (106, 113, 119, 125, 130, 135, 139),
                '40': (106, 113, 119, 125, 130, 135, 139),
           },
       }    
